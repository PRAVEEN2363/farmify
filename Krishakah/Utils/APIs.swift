...
//  BugLogy
//
//  Created by RichLabs on 23/06/20.
//  Copyright © 2020 RichLabs. All rights reserved.
//
...
class APIs: NSObject
{
    static let baseURL = "https://maziato.com/api/"
    static let internetStatus = "Please Check Internet Connection."
}

class UserDetails: NSObject
{
    static let userEmail = "EmailId"
...
{
    func MaziatoAlert(Alertmessage:String)
    {
...
extension UIButton
{
    func buttonShadowEffect(button:UIButton)
    {
